...
public class PresencaAdapter extends BaseExpandableListAdapter {
	...
	public PresencaAdapter(Context context, List<String> listDataHeader, HashMap<String, List<NameValuePair>> listDataChild) {
	...
	public View getChildView(int groupPosition, final int childPosition, boolean isLastChild, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			...
			convertView = infalInflater.inflate(R.layout.list_presenca_item, null);
		}

		TextView txtListChild = (TextView) convertView.findViewById(R.id.presenca_txt1);		
		txtListChild.setText(childText.getName());
		
		TextView txtNumero = (TextView) convertView.findViewById(R.id.presenca_txt2);		
